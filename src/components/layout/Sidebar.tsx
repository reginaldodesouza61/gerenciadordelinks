...
interface SidebarProps {
  onLinkClick?: () => void; // Para fechar menu mobile ao clicar
}
...
export function Sidebar({ onLinkClick }: SidebarProps) {
  ...
  const openSubcategoryDialog = (isEditing = false, subcategory?: Subcategoria, categoryId?: string) => {
    ...
    setSubcategoryName(isEditing && subcategory ? subcategoria.nome : '');
    setSubcategoryCategoryId(isEditing && subcategory ? subcategoria.categoria_id : categoryId || '');
    setCurrentSubcategoryId(isEditing && subcategory ? subcategoria.id : null);
  ...
  return (
    <>
          ...
          {(selectedCategoryId || selectedSubcategoryId) && (
            <Button
              ...
              onClick={() => {
                ...
                if (onLinkClick) onLinkClick(); // fecha mobile menu
              }}
            >
              ...
              >
                <button
                  ...
                  onClick={() => {
                    ...
                    if (onLinkClick) onLinkClick(); // fecha menu mobile
                  }}
                >
                    ...
                    .map(subcategoria => (
                      ...
                      >
                        <button
                          ...
                          onClick={() => {
                            setSelectedSubcategoryId(
                              selectedSubcategoryId === subcategoria.id ? null : subcategoria.id
                            );
      ...
      <Dialog open={isCategoryDialogOpen} onOpenChange={setCategoryDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{isEditingCategory ? 'Editar Categoria' : 'Nova Categoria'}</DialogTitle>
          </DialogHeader>
      ...
      <Dialog open={isSubcategoryDialogOpen} onOpenChange={setSubcategoryDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{isEditingSubcategory ? 'Editar Subcategoria' : 'Nova Subcategoria'}</DialogTitle>
          </DialogHeader>
